...
"""
head=chicken_head + rabbit_head
leg=chicken_leg*2 + rabbit_leg*4
if head=10:
    leg=32
    calculate(chicken_head)
    calculate(rabbit_head)
    print(calculate(chicken_head),calculate(rabbit_head))
if head=12:
    leg=32
    calculate(chicken_head)
    calculate(rabbit_head)
