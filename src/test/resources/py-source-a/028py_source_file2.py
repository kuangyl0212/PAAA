...
def calculate(head,leg):
    for head_chicken in range(head+1):
        for head_rabbit in range(head+1):
            if leg==head_chicken*2+head_rabbit*4,
            head=head_chicken+head_rabbit:
                print(head_chicken,head_rabbit)
    return 
