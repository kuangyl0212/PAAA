...
public class Parameter {
    ...
    public static final double SCALE_BASE       = 1000.0;
    ...
    public static final double EXPR_STAT        = 10;           /* expression statement         */
    public static final double ITER_STAT        = 10;           /* iteration statement          */
    public static final double JUMP_STAT        = 10;           /* jump statement               */
    public static final double SEL_STAT         = 10;           /* selection statement          */
    public static final double SEL_CLAUSE       = 10;           /* selection clause             */
